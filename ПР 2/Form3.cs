...
namespace ПР_2
{
    public partial class Form3 : Form
    {
        ...
        // Метод для поиска минимума методом золотого сечения
        private double FindMinimum(double a, double b, double e, string fx)
        {
            ...
            // Значения функции в точках c и d
            ...
            while (Math.Abs(b - a) >= e)
            {
                if (fc < fd)
                {
                    // Минимум находится в интервале [a, d]
                    b = d;
                    d = c;
                    fd = fc;
                    c = b - phi * (b - a);
                ...
                {
                    // Минимум находится в интервале [c, b]
                    a = c;
                    c = d;
                    fc = fd;
                    d = a + phi * (b - a);
                    fd = EvaluateFunction(fx, d);
                }
            }

            // Возвращаем середину интервала как приближение минимума
            return (a + b) / 2;
        }
